...
#define I2CDMA_DW__CHANNEL_HW DW0_CH_STRUCT0
#define I2CDMA_DW__CHANNEL_NUMBER 0u
#define I2CDMA_DW__TR_IN TRIG0_OUT_CPUSS_DW0_TR_IN0
#define I2CDMA_DW__TR_OUT TRIG10_IN_CPUSS_DW0_TR_OUT0

/* UARTDMA */
#define UARTDMA_DW__BLOCK_HW DW0
#define UARTDMA_DW__BLOCK_NUMBER 0u
#define UARTDMA_DW__CHANNEL_HW DW0_CH_STRUCT3
#define UARTDMA_DW__CHANNEL_NUMBER 3u
#define UARTDMA_DW__TR_IN TRIG0_OUT_CPUSS_DW0_TR_IN3

/* ADCDMA_0 */
#define ADCDMA_0_DW__BLOCK_HW DW0
#define ADCDMA_0_DW__BLOCK_NUMBER 0u
#define ADCDMA_0_DW__CHANNEL_HW DW0_CH_STRUCT2
#define ADCDMA_0_DW__CHANNEL_NUMBER 2u
#define ADCDMA_0_DW__TR_IN TRIG0_OUT_CPUSS_DW0_TR_IN2
#define ADCDMA_0_DW__TR_OUT TRIG10_IN_CPUSS_DW0_TR_OUT2

/* ADCDMA_1 */
#define ADCDMA_1_DW__BLOCK_HW DW0
#define ADCDMA_1_DW__BLOCK_NUMBER 0u
#define ADCDMA_1_DW__CHANNEL_HW DW0_CH_STRUCT1
#define ADCDMA_1_DW__CHANNEL_NUMBER 1u
#define ADCDMA_1_DW__TR_IN TRIG0_OUT_CPUSS_DW0_TR_IN1
#define ADCDMA_1_DW__TR_OUT TRIG10_IN_CPUSS_DW0_TR_OUT1

/* ADCDMA_2 */
#define ADCDMA_2_DW__BLOCK_HW DW0
#define ADCDMA_2_DW__BLOCK_NUMBER 0u
#define ADCDMA_2_DW__CHANNEL_HW DW0_CH_STRUCT5
#define ADCDMA_2_DW__CHANNEL_NUMBER 5u
#define ADCDMA_2_DW__TR_IN TRIG0_OUT_CPUSS_DW0_TR_IN5

/* ADCDMA_3 */
#define ADCDMA_3_DW__BLOCK_HW DW0
#define ADCDMA_3_DW__BLOCK_NUMBER 0u
#define ADCDMA_3_DW__CHANNEL_HW DW0_CH_STRUCT4
#define ADCDMA_3_DW__CHANNEL_NUMBER 4u
#define ADCDMA_3_DW__TR_IN TRIG0_OUT_CPUSS_DW0_TR_IN4
